...
public class CategoryServiceImpl implements CategoryService{
    ...
    public CategoryResponseDTO getProductByCategoryId(int categoryId) {
        Category category = categoryRepository.findById(categoryId)
                .orElseThrow(() -> new RuntimeException("Cant delete us by this id"));
        List<Product> productList = category.getProductList();
        List<ProductResponseDTO> productResponseDTOList = productMapper.convertEntiitiesToResponseDtos(productList);
        CategoryResponseDTO categoryResponseDTO= categoryMapper.convertEntiitiesToResponseDto(category);
